import { listItem, listItemBtn, listItemIcon } from '@/styled/media-queries-mui'
...
export const TagsBlock: React.FC<ITagsBlock> = ({
	items,
	isLoading = true,
}) => {
	return (
